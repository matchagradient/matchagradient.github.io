...
<head>
    <meta charset="UTF-8">
    <title>SVG Sphere Generator</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <svg class="sphere-background" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice">
        <defs></defs>
        <g id="sphereContainer"></g>
    </svg>

    <div class="content">
        <h1>SVG Sphere Generator</h1>
        <p>Build random SVG spheres and customize the color, opacity, and size using controls.</p>
        
        <div class="controls">
            <div class="control-group">
                <div class="control-item">
                    <label for="cubeCount">Number of Spheres:</label>
